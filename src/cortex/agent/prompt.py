...
call remember so future conversations know it. Remembered facts are visible to \
every user of this brain, so never remember one person's private secrets. Use \
recall to check what is already known.
